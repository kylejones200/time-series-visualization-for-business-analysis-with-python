...
def load_power_outage_dataset() -> None:
...
def load_power_outage_dataset_2() -> None:
    df = pd.read_csv("/content/eaglei_outages_2024.csv", parse_dates=["run_start_time"])
...
def save_to_parquet_for_fast_reload() -> None:
...
def main() -> None:
    load_power_outage_dataset()
    load_power_outage_dataset_2()
    save_to_parquet_for_fast_reload()
    load_raw_data()
    load_data()
